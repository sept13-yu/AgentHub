...
public static class PriceSyncService
{
    ...
    [
        ...
        new() { Model = "GLM-5.3-Flash", InputPer1m = 0.8, OutputPer1m = 2.8, CacheReadPer1m = 0.16, CacheWritePer1m = 0.0, Currency = "CNY" },
                // DeepSeek Flash 峰时价（工作日 9–12 / 14–18 北京时间）；估费偏保守。CNY/1M：缓存 0.04 / 输入 2 / 输出 8（官方峰时=2×非高峰）。
        new() { Model = "deepseek-v4.1-flash", InputPer1m = 2.0, OutputPer1m = 8.0, CacheReadPer1m = 0.04, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "deepseek-flash", InputPer1m = 2.0, OutputPer1m = 8.0, CacheReadPer1m = 0.04, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "deepseek-v4.1-flash-expires-on-0910", InputPer1m = 2.0, OutputPer1m = 8.0, CacheReadPer1m = 0.04, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "deepseek-v4-flash", InputPer1m = 2.0, OutputPer1m = 8.0, CacheReadPer1m = 0.04, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "deepseek-v4-flash-vision-exp", InputPer1m = 2.0, OutputPer1m = 8.0, CacheReadPer1m = 0.04, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "deepseek-v4-pro", InputPer1m = 9.0, OutputPer1m = 27.0, CacheReadPer1m = 0.299997, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "DeepSeek-V4-Flash 正式版", InputPer1m = 2.0, OutputPer1m = 8.0, CacheReadPer1m = 0.04, CacheWritePer1m = 0.0, Currency = "CNY" },
        ...
        new() { Model = "mimo-v2.6-pro", InputPer1m = 3.0, OutputPer1m = 6.0, CacheReadPer1m = 0.025, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "mimo-v2.6-pro-ultraspeed", InputPer1m = 30.0, OutputPer1m = 60.0, CacheReadPer1m = 0.25, CacheWritePer1m = 0.0, Currency = "CNY" },
