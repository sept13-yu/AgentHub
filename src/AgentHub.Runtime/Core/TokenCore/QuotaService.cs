...
public sealed class QuotaService
{
    ...
    {
        var key = Secrets.Unprotect(_config.Credentials.DeepSeekKey);
    ...
    {
        var key = Secrets.Unprotect(_config.Credentials.RelayKey);
        if (string.IsNullOrEmpty(key))
    ...
    {
        var session = WorkBuddyAuth.ResolveQuotaSession(Secrets.Unprotect(_config.Credentials.WorkBuddySession));
