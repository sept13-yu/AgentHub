...
public static class PriceSyncService
{
    ...
    [
        ...
        new() { Model = "GLM-5.3-Flash", InputPer1m = 0.8, OutputPer1m = 2.8, CacheReadPer1m = 0.16, CacheWritePer1m = 0.0, Currency = "CNY" },
                // DeepSeek V4.1 Flash 非高峰列表价（CNY/1M）：命中缓存 0.02 / 未命中 1 / 输出 4；官方 API id deepseek-flash。
        new() { Model = "deepseek-v4.1-flash", InputPer1m = 1.0, OutputPer1m = 4.0, CacheReadPer1m = 0.02, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "deepseek-flash", InputPer1m = 1.0, OutputPer1m = 4.0, CacheReadPer1m = 0.02, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "deepseek-v4.1-flash-expires-on-0910", InputPer1m = 1.0, OutputPer1m = 4.0, CacheReadPer1m = 0.02, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "deepseek-v4-flash", InputPer1m = 1.0, OutputPer1m = 4.0, CacheReadPer1m = 0.02, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "deepseek-v4-flash-vision-exp", InputPer1m = 1.0, OutputPer1m = 4.0, CacheReadPer1m = 0.02, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "deepseek-v4-pro", InputPer1m = 9.0, OutputPer1m = 27.0, CacheReadPer1m = 0.299997, CacheWritePer1m = 0.0, Currency = "CNY" },
        new() { Model = "DeepSeek-V4-Flash 正式版", InputPer1m = 1.0, OutputPer1m = 4.0, CacheReadPer1m = 0.02, CacheWritePer1m = 0.0, Currency = "CNY" },
